...
async function walkPickedDir(
  ...
  async function visit(
    ...
    // @ts-expect-error -- FileSystemDirectoryHandle.values() is in lib.dom now but older TS defs don't include it
...
// Color the groundedness score: green ≥ 0.6, amber 0.3-0.6, red < 0.3.
...
export default function HomePage() {
  ...
  async function onPickDirectory() {
    ...
    try {
      ...
      if (e.name === "AbortError") {
        // User cancelled the picker — not an error worth shouting about.
        setError(null);
      } else {
  ...
  // ----- AC3: QA mode with per-sentence groundedness -----
